...
def transpose3D(a, dim_0, dim_1, dim_2, device0):
    @tf.custom_gradient
    def _lambda():
        return transpose3D_real(a, dim_0, dim_1, dim_2, device0)
    return _lambda()

def transpose3D_real(a, dim_0, dim_1, dim_2, device0):
    out = gp_apis.gp_transpose3D(a, dim_0, dim_1, dim_2, device0)
    def grad():
        return gp_apis.gp_transpose3D(a, dim_0, dim_1, dim_2, device0)
    return out, grad

def batch_mm(a, b, dim;_0, dim;_1, dim;_2, device0):
    @tf.custom_gradient
    def _lambda():
        return batch_mm_real(a, b, dim;_0, dim;_1, dim;_2, device0)
    return _lambda()

def batch_mm_real(a, b, dim;_0, dim;_1, dim;_2, device0):
    out = gp_apis.gp_batch_mm(a, b, dim;_0, dim;_1, dim;_2, device0)
    def grad():
        return gp_apis.gp_batch_mm(a, b, dim;_0, dim;_1, dim;_2, device0)
    return out, grad

def transpose(a, dim;_0, dim;_1, device0):
    @tf.custom_gradient
    def _lambda():
        return transpose_real(a, dim;_0, dim;_1, device0)
    return _lambda()

def transpose_real(a, dim;_0, dim;_1, device0):
    out = gp_apis.gp_transpose(a, dim;_0, dim;_1, device0)
    def grad():
        return gp_apis.gp_transpose(a, dim;_0, dim;_1, device0)
    return out, grad

def mm(input1, input2, dim;_0, dim;_1, device0):
    @tf.custom_gradient
    def _lambda(X1, X2):
        return mm_real(X1, X2, dim;_0, dim;_1, device0)
    return _lambda(input1, input2)

def mm_real(input1, input2, dim;_0, dim;_1, device0):
    out = gp_apis.gp_mm(input1, input2, dim;_0, dim;_1, device0)
    def grad(dZ1, dZ2):
        return gp_apis.gp_mm(dZ1, dZ2, dim;_0, dim;_1, device0)
    return out, grad

def sum_two_tensors(input1, input2, dim;_0, dim;_1, device0):
    @tf.custom_gradient
    def _lambda(X1, X2):
        return sum_two_tensors_real(X1, X2, dim;_0, dim;_1, device0)
    return _lambda(input1, input2)

def sum_two_tensors_real(input1, input2, dim;_0, dim;_1, device0):
    out = gp_apis.gp_sum_two_tensors(input1, input2, dim;_0, dim;_1, device0)
    def grad(dZ1, dZ2):
        return gp_apis.gp_sum_two_tensors(dZ1, dZ2, dim;_0, dim;_1, device0)
    return out, grad
